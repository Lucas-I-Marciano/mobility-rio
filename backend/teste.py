from app.api.mock.mocks import return_bus_filter
from app.services.bus_filtering import filter_and_paginate_buses, add_distance_to_buses, get_latest_bus_records
from app.utils.bus_record import process_vehicle_data, sort_by_time

from datetime import datetime, timezone
from zoneinfo import ZoneInfo

# # filter_and_paginate_buses Importante e vou deixar para ser usada no endpoint de filter
paginated_list = filter_and_paginate_buses(return_bus_filter(), limit=10, page=1)
# print(paginated_list)

###############################################################

# # add_distance_to_buses importante e só adiciona uma chave a mais na lista
list_with_distance = add_distance_to_buses(return_bus_filter(), -22.95168, -43.34861)
# print(list_with_distance)

###############################################################
# # get_latest_bus_records importante para pegar o registro mais recente, coloca a ordem como chave e o valor é o último registro
# latest_buses = get_latest_bus_records(list_with_distance)
# print(len(latest_buses.keys()) == len(set(latest_buses.keys()))) # True

# list_C51578 = []
# for i in list_with_distance:
#     ordem = i["ordem"]
#     if ordem == "C51578":
#         list_C51578.append(i)

# print(list_C51578) 
# # [
# #     {'ordem': 'C51578', 'latitude': '-22,87902', 'longitude': '-43,34133', 'datahora': '1745702710000', 'velocidade': '24', 'linha': '371', 'datahoraenvio': '1745702719000', 'datahoraservidor': '1745702729000', 'distance_km': 8.11}, 
# #     {'ordem': 'C51578', 'latitude': '-22,87618', 'longitude': '-43,33947', 'datahora': '1745702642000', 'velocidade': '0', 'linha': '371', 'datahoraenvio': '1745702729000', 'datahoraservidor': '1745702759000', 'distance_km': 8.45}, 
# #     {'ordem': 'C51578', ..., 'datahora': '1745702741000', 'velocidade': '0', 'linha': '371', 'datahoraenvio': '1745702750000', 'datahoraservidor': '1745702759000', 'distance_km': 8.05}
# # ]
# print(latest_buses["C51578"]) # {'ordem': 'C51578', 'latitude': '-22,87952', 'longitude': '-43,34173', 'datahora': '1745702741000', 'velocidade': '0', 'linha': '371', 'datahoraenvio': '1745702750000', 'datahoraservidor': '1745702759000', 'distance_km': 8.05}
# all_datahora_C51578 = ["1745702710000", "1745702642000", "1745702741000"]
# for datahora in all_datahora_C51578:
#     print(int(latest_buses["C51578"]["datahora"]) >= int(datahora))
...
def get_line_status_with_eta(line_id: str, dest_lat: float, dest_lng: float) -> List[BusStatus]:
    ...
    full_bus_list = return_bus_filter()
...
a = get_line_status_with_eta("371", -22.87902, -43.34133)

b = process_vehicle_data({"results": add_distance_to_buses(return_bus_filter(), -22.95168, -43.34861)})
c = sort_by_time(add_distance_to_buses(return_bus_filter(), -22.95168, -43.34861), "datahora")
